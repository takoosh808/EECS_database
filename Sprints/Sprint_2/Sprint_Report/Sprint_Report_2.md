...
This sprint was primarily focused on creating the basic workflow of the admin and the user, including routing, user facing responses, and ingestion.

## Unfinished Work
This sprint we finished everything that was required of us. We completed two different functionalities per team member, as well as created multiple tests for each feature, and ensured that the user workflows were complete.
